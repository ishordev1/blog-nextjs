...
const Footer = () => {
  ...
  <div className="container p-5 mx-auto border-2">
  ...
  <div className="">
    <div className="container px-5 py-3 border-b- mb-3 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm  sm:ml-6 sm:mt-0 mt-4">© 2020 Tailblocks —
