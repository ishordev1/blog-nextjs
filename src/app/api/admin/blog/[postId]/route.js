...
export async function DELETE(req, context) {
  try {
    ...
    const res=await DeleteFileFromCloudinary(imgUrl);
    ...
    if(!res.success){
      console.error("Failed to delete image from Cloudinary:", res.error);
      return NextResponse.json(
        { message: "Failed to delete associated image", success: false },
        { status: 500 }
      );
    }
